...
public class CommandHelpTest {
    ...
    public void executeCommand() {
        ...
        String correctText = "The game has four possible endings. Two of which are bad, one good and one perfect.\n" +
        ...
        assertEquals(correctText, commandHelp.executeCommand());
    }
}