...
public class TalkTest {
    ...
    public void setUp() {
        ...
        Game game = new Game();
        talk = new Talk(plan, backpack, money, progress, game);
    }

    @Test
    public void executeCommand() {
        assertEquals("There is no such NPC in here.", talk.executeCommand("test"));
    }

    @Test
    public void executeCommandPeppa() {
        progress.setProgress(6);
        talk.executeCommand("peppa");
    ...
    public void executeCommandShopAssistant() {
        ...
        talk.executeCommand("shopAssistant");
    ...
    public void executeCommandPawnBroker() {
        ...
        talk.executeCommand("pawnbroker");
